...
public class Level9 extends AppCompatActivity {
    ...
    String[] maps = new String[]{"fl1", "fl2", "fl3", "fl4", "fl5", "fl6", "fl7", "fl8", "fl9", "fl10", "fl11", "fl12", "fl13"};
    String n;
    int counter, level,q;
    boolean answer;
    int i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number.setText("Welcome to Level 8, " + n);
        setTitle("Level 8 Provincial Flowers");
    ...
    private void checkScore() {
        if (i > 10 && ((counter / (i - 1)) > .9)) {    //questions changed to for testing.....change back to 25
            //next level
            Toast.makeText(this, "CONGRATULATIONS.....You have completed Level 9", Toast.LENGTH_LONG).show();
            level++;
            dbUpdate(n,level);
    ...
    void dbUpdate(String name, int level) {
        ...
        refChild.setValue(10);
    }
    void errorDialog(){
        AlertDialog.Builder ad = new AlertDialog.Builder(this);
        ad.setMessage("TRIP.....STUMBLE...CRASH!/n/nThe correct answer is /n/n"+pName[q]+"/n")
                .setTitle("         OOPS!!!")
